  ...
  return (
    <Comparison
      a={
        <div style={{ display: "flex", flexDirection: "column", gap: ".5rem" }}>
          <File
            name="krom-player.vercel.app"
            className={active === "pc" && styles.active}
            onPointerOver={() => setActive("pc")}
          />
          <File
            name="krom-turn.vercel.app"
            className={active === "kt" && styles.active}
            onPointerOver={() => setActive("kt")}
          />
        </div>
      }
      b={
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Sistema de Juego de Rol <br className='sm:block hidden'/>(de papel y lapiz) Gratuito</h1>
    <p className="subtitle">Tactico, Poderoso, Curva de aprendizaje intermedia</p>
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs/guide/image">
          <div className="h-full flex flex-col justify-between">
            ...
            <p className='mb-1'>Cada personaje tiene un repertorio de cosas para hacer durante y fuera del combate</p>
            <p className='mb-8'>Siempre hay una [Respuesta](/docs/guide/tratado-combate) para dar!</p>
            <div>
        ...
        <Feature index={2} href="/docs/guide/i18n">
          <h3>Herramientas online <br className="show-on-mobile"/>gratis</h3>
          <p className='mb-4'>Diferentes apps que se encargan de ayudar al director y los jugadores.</p>
          <RandomTools/>
        </Feature>
        ...
        <Feature index={4} id="highlighting-card" href="/docs/guide/syntax-highlighting">  
          <h3>Ricos transfondos. <br className="show-on-mobile"/>Decisiones que importan.</h3>
          <p>Tanto en las [Especies](/docs/guide/lista-de-clases) como las [Subclases](/docs/guide/lista-de-clases)</p>
        </Feature>
        <Feature index={5} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
        ...
        <Feature index={6} href="/docs/about">
          <h3>Licencia: MIT</h3>
          <p className='mr-6'>Podés construir, modificar y alterar el sistema a gusto!. Sin clausulas raras, cash grabs o cambios inesperados!</p>
        </Feature>
