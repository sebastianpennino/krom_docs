...
<div className="home-content">
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs/rules-magic">
        ...
        <Feature index={1} centered className="card-with-border" href="/docs/rules-combat">
          <div className="h-full flex flex-col justify-between">
            ...
            <p className='mb-8'>Siempre hay una [Respuesta](/docs/rules-combat/05) para dar!</p>
            <div>
