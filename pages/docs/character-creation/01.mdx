...
en la hoja de personaje donde dice 'especie'.</Callout>
...
**Mago-Guerreros**
* **[Paladin](/docs/list-classes/w-mage/paladin)** - Un semi-mago con saberes de escudos que busca proteger y ayudar
...
* **[Clerigo](/docs/list-classes/shaman/cleric)** - Protector, reparador y devoto, en contacto con las fuerzas de la luz
...
* **[Psiquico](/docs/list-classes/mage/psi)** - Mago de la mente, los engaños y el control
