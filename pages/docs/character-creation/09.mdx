...
With Kromsys, all your `.mdx` files under the pages directory will be rendered
...
Besides basic MDX, Kromsys also has some advanced Markdown features built-in.
...
```md filename="Markdown"
## Long heading about Kromsys [#about-nextra]
```
