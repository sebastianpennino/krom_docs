...
Then Kromsys will automatically generate the correct file path for all pages.
...
export default {
  head: (
    <>
      ...
      <meta property="og:title" content="Kromsys" />
  ...
  head: () => {
    ...
    return (
      <>
        ...
        <meta property="og:title" content={frontMatter.title || 'Kromsys'} />
        <meta
...
You can refer to the [`useConfig`](/docs/tbd)
...
it links to Kromsys’s GitHub repository.
...
Check out [Page Configuration](/docs/tbd)
  ...
  banner: {
    ...
    text: (
      <a href="https://nextra.site" target="_blank">
        🎉 Kromsys 2.0 is released. Read more →
      </a>
    )
  }
}
...
Together with the [Separators](/docs/tbd)
